...
export class VisualizationPointsEvaluator {
  private pushIfNotContain(array: any[], entry: any) {
    let found = false;
    array.map( (item) => {
  ...
  private pushInList(list: any[], item: any, node: any, allowduplicates: boolean, groupduplicates: boolean, displayData: any) {
  ...
  evaluatePoints(data: any[], pickPoints: any[], primarys: any[], allowduplicates: boolean, groupduplicates: boolean) {
